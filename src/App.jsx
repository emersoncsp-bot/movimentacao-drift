...
function AppInner() {
  ...
  return (
    <div className="app">
      ...
      {page === 'saida'    && <MovimentacaoDrift tipo="saida"   onBack={goHome} showToast={showToast} />}
      {page === 'entrada'  && <MovimentacaoDrift tipo="entrada" onBack={goHome} showToast={showToast} />}
